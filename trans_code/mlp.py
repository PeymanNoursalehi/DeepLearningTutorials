...
class HiddenLayer(object):
    def __init__(self, rng, n_in, n_out, W=None, b=None,
        ...
        if b is None:
            b = numpy.zeros((n_out,), dtype=config.floatX)
    ...
    def calc_activation(self, X):
        return self.activation(self.lin_output(X))
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
   ...
   """
    ...
    classifier = MLP(rng=rng, n_in=28 * 28,
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            train_model(
                classifier, learning_rate, train_set_x, train_set_y, minibatch_index,
                n_train_batches, L1_reg, L2_reg)
            ## iteration number
